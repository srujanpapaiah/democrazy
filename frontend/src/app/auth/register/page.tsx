  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20">
      <div className="max-w-sm mx-auto">
        ...
        <p className="text-sm text-slate-500 text-center mb-6">Get your own blockchain wallet</p>
        ...
        <form onSubmit={handleSubmit} className="bg-surface-2 border border-surface-border rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full bg-black/25 border border-surface-border rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 outline-none transition-colors" />
          </div>
          <div>
            <label className="block text-[11px] font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Password</label>
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="w-full bg-black/25 border border-surface-border rounded-lg px-3 py-2.5 text-sm text-white placeholder-slate-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 outline-none transition-colors" />
            <p className="text-[10px] text-slate-600 mt-1">Minimum 6 characters</p>
          </div>
